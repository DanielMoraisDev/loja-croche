...
const Sponsored = () => {
  ...
  return (
    <div className="px-32 py-12 w-full flex flex-col justify-center items-center gap-8 bg-soft_light_yellow">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {entregas.map((item, index) => (
          <div
            key={index}
            className="flex flex-row p-6 bg-soft_fresh_green gap-4 rounded-xl hover:cursor-pointer
          ...
          >
            <div
              className="bg-very_light_saturated_orange text-deep_orange border-[3px] 
                          rounded-full flex justify-center items-center p-4 border-deep_orange"
            >
              {item.icon}
            </div>
